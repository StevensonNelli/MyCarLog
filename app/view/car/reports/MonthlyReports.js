Ext.define('MyCarLog.view.car.reports.MonthlyReports', {
    ...
    items: [{
        ...
        items: [{
		   ...
		   sprites: [{
	                type: 'text',
	                text: 'Fuel & Maintenance cost monthly',
	                font: '14px Helvetica',
	                width: 150,
	                height: 10,
	                x: 10, // the sprite x position
